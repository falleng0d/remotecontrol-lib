...
const Map<String, int> _keyToVK = {
  ...
  'MEDIA_SELECT': VK_LAUNCH_MEDIA_SELECT,
  'MEDIA_EMAIL': VK_LAUNCH_MAIL,
  'MEDIA_CALCULATOR': VK_LAUNCH_APP1,
  'MEDIA_BACK': VK_BROWSER_BACK,
  'MEDIA_FORWARD': VK_BROWSER_FORWARD,
  'MEDIA_REFRESH': VK_BROWSER_REFRESH,
};
